...
namespace Multiplayer_Game
{
    class Program
    {
        ...
        enum playerMove
        { Gunting, Batu, Kertas, Exit, noInput, }
        ...
        static string game()
        {
            ...
            switch (choose)
            {
                ...
                case 1:
                    player.move = playerMove.Gunting;
                    input = Convert.ToString(player.move);
                    break;

                case 2:
                    player.move = playerMove.Batu;
                    input = Convert.ToString(player.move);
                    break;

                case 3:
                    player.move = playerMove.Kertas;
                    input = Convert.ToString(player.move);
                    break;
        ...
        {
            if (opponentAnswer == Convert.ToString(playerMove.Gunting))
            {
                //  Gunting
                if (yourAnswer == Convert.ToString(playerMove.Batu))
                {
                    Console.WriteLine();
                    Console.WriteLine("You lose...");
                    Console.WriteLine();
                }
                else if (yourAnswer == Convert.ToString(playerMove.Kertas))
                {
                    Console.WriteLine();
                    Console.WriteLine("You win...");
                    Console.WriteLine();
                }
                else if (yourAnswer == Convert.ToString(playerMove.Gunting))
                {
                    Console.WriteLine();
            ...
            if (opponentAnswer == Convert.ToString(playerMove.Batu))
            {
                //  Batu
                if (yourAnswer == Convert.ToString(playerMove.Kertas))
                {
                    Console.WriteLine();
                    Console.WriteLine("You lose...");
                    Console.WriteLine();
                ...
                else if (yourAnswer == Convert.ToString(playerMove.Batu))
                {
                    Console.WriteLine();
                    Console.WriteLine("Draw...");
                    Console.WriteLine();
            ...
            if (opponentAnswer == Convert.ToString(playerMove.Kertas))
            {
                //  Kertas
                if (yourAnswer == Convert.ToString(playerMove.Gunting))
                {
                    Console.WriteLine();
                    Console.WriteLine("You lose...");
                    Console.WriteLine();
